...
{
	return "INSERT INTO Commande (total_HT, TVA,date_commande,date_livraison, adresse_livraison) VALUES('" + this->total_HT + "','" + this->TVA + "',CAST(' " + this->date_commande + "'AS date),'CAST(' " + this->date_livraison + "'AS date)," + this->adresse_livraison + "');";
}
