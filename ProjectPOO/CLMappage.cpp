...
{
	return "SELECT [id_employe], [nom_employe], [prenom_employe],[date_naissance_employe],[id_superviseur] FROM Employe;";
}
System::String^ NS_Comp_Mappage::CLMappage::Insert(void)
{
	return "INSERT INTO Employe (nom_employe, prenom_employe,id_superviseur,date_naissance_employe) VALUES('" + this->nom_employe + "','" + this->prenom_employe + "', 1,'2003-10-23'); ";
}
System::String^ NS_Comp_Mappage::CLMappage::Delete(void)
{
	return "DELETE FROM Client WHERE (nom_client='" + this->nom_employe + "'AND prenom_client='" + this->prenom_employe + "' AND id_client=" + this->id_employe + ");";
}
System::String^ NS_Comp_Mappage::CLMappage::Update(void)
{
	return "UPDATE Client SET nom_client='" + this->nom_employe + "', prenom_client='" + this->prenom_employe + "', date_naissance_employe='" + this->date_naissance_employe + "' WHERE id_client=" + id_employe + ";";
}
...
void NS_Comp_Mappage::CLMappage::setdate_naissance_employe(System::String^ prenom_employe)
{
