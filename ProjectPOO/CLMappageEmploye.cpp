...
void NS_Comp_Mappage::CLMappageEmploye::setid_superviseur(System::String^ id_superviseur)
{
...
System::String^ NS_Comp_Mappage::CLMappageEmploye::getid_superviseur(void) { return this->id_superviseur; }