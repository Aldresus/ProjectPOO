...
void NS_Comp_Svc::CLservices::ajouterUnePersonne(System::String^ nom_client, System::String^ prenom_client, System::String^ id_client, System::String^ date_naissance_client, System::String^ date_inscription, System::String^ adresse_client)
{
    System::String^ sql;
